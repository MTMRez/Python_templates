...
class GFG: 
    ...
    def movement(self): 
        ...
        self.canvas.after(50, self.movement) #will keep recalling this method after a certain interval
...
if __name__ == "__main__": 
    ...
    master.bind("<space>", lambda e: gfg.stop(e)) 
